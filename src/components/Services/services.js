  ...
  return (
    ...
    <div className='service-body'>
      <div className="service-web service-items">
        ...
        <div className='web-theory service-pic'>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour</div>
      </div>
      ...
      <div className='app-theory service-pic'>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour</div>
      </div>
      ...
      <div className='digital-theory service-pic'>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour</div>
      </div>
    </div>
    </div>
   )
